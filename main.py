"""ML service for chapkit_minimalist_example_py."""
...
class ChapkitMinimalistExamplePyConfig(BaseConfig):
    """Configuration for chapkit_minimalist_example_py."""
...
#   model.pickle - Model file (pickle.dump / pickle.load in your scripts)
...
runner: ShellModelRunner[ChapkitMinimalistExamplePyConfig] = ShellModelRunner(
...
info = MLServiceInfo(
    ...
    description=(
        ...
        "for chapkit-py model authors - copy and replace LinearRegression in "
        "scripts/train_model.py with the real model."
    ),
...
HIERARCHY = ArtifactHierarchy(
    name="chapkit_minimalist_example_py",
...
app = (
    MLServiceBuilder(
        info=info,
        config_schema=ChapkitMinimalistExamplePyConfig,
        hierarchy=HIERARCHY,
        runner=runner,
